...
__Note that you'll need both opening and closing functions, either in a package or interactively__.
...
__Please note that you need to create BOTH functions when using interactively.__
